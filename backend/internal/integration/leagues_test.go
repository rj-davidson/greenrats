...
func TestLeaguesIntegration(t *testing.T) {
	...
	t.Run("leaderboard integration", func(t *testing.T) {
		...
		factory.CreatePlacement(tourn, golfer1, testutil.WithEarnings(500000))
		factory.CreatePlacement(tourn, golfer2, testutil.WithEarnings(250000))
	...
	t.Run("league tournaments view", func(t *testing.T) {
		...
		factory.CreatePlacement(tourn1, golfer, testutil.WithEarnings(100000))
