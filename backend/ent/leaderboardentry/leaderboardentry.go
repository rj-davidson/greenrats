...
const (
	// Label holds the string label denoting the leaderboardentry type in the database.
	Label = "leaderboard_entry"
	...
	EdgeRounds = "rounds"
	// Table holds the table name of the leaderboardentry in the database.
	Table = "leaderboard_entries"
	// TournamentTable is the table that holds the tournament relation/edge.
	TournamentTable = "leaderboard_entries"
	...
	TournamentColumn = "tournament_leaderboard_entries"
	// GolferTable is the table that holds the golfer relation/edge.
	GolferTable = "leaderboard_entries"
	...
	GolferColumn = "golfer_leaderboard_entries"
	...
	RoundsColumn = "leaderboard_entry_rounds"
)

// Columns holds all SQL columns for leaderboardentry fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "leaderboard_entries"
...
func StatusValidator(s Status) error {
	...
	case StatusPending, StatusActive, StatusWithdrawn, StatusFinished:
		return nil
	default:
		return fmt.Errorf("leaderboardentry: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the LeaderboardEntry queries.
